...
namespace ProWebbCore.Api.Migrations
{
    ...
    [Migration("20220221212903_create_skills_model")]
    partial class create_skills_model
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProWebbCore.Shared.Life.Nutrition.Goal", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProWebbCore.Shared.Life.Nutrition.Split", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<double>("CarbohydrateSplit")
                        .HasColumnType("double");

                    b.Property<double>("FatSplit")
                        .HasColumnType("double");

                    b.Property<int>("GoalID")
                        .HasColumnType("int");

                    b.Property<double>("ProteinSplit")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("ProWebbCore.Shared.Life.Nutrition.Split", b =>
                {
                    b.HasOne("ProWebbCore.Shared.Life.Nutrition.Goal", null)
                        .WithOne("Split")
                        .HasForeignKey("ProWebbCore.Shared.Life.Nutrition.Split", "GoalID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ProWebbCore.Shared.Numbers.KeyNote", b =>
                {
                    b.HasOne("ProWebbCore.Shared.Numbers.Key", null)
                        .WithMany("Notes")
                        .HasForeignKey("KeyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
